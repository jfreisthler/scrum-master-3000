...
import com.google.android.gms.samples.vision.face.multitracker.RemoteUserProxy;
/**
...
public class GraphicOverlay extends View {
    ...
    public Graphic getSelected(int x, int y){
        for (Graphic graphic : mGraphics) {
            if (graphic.isSelected(x,y))
                return graphic;
        }
        return null;
    }
    ...
    public static abstract class Graphic {
        ...
        public boolean isSelected(int x, int y){
            ...
            try {
                result = mBoundingRect.contains(x, y);
            }
            catch(Exception ex){
                return false;
            }
    ...
    public void drawRemoteUser(Canvas canvas){

        Bitmap b = BitmapFactory.decodeResource(getResources(),R.drawable.porg);
        canvas.drawBitmap(b,400,400,null);
    }
}
