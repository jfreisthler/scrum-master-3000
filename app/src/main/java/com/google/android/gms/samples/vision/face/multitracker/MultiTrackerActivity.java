...
import com.google.android.gms.samples.vision.face.multitracker.ui.camera.GraphicOverlay.Graphic;
...
public final class MultiTrackerActivity extends AppCompatActivity {
    ...
    private boolean remoteUsersDisplayed = false;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch(event.getAction()){
            case MotionEvent.ACTION_UP:
                ...
                Graphic graphic = mGraphicOverlay.getSelected(touchX, touchY);
                if (graphic != null) {
                    showPopupWindow(graphic);
                }else{
                    if (!remoteUsersDisplayed) {
                        RemoteUserProxy remoteUser = new RemoteUserProxy(BitmapFactory.decodeResource(getResources(), R.drawable.porg));
                        RemoteUserGraphic remoteUserProxy = new RemoteUserGraphic(remoteUser, mGraphicOverlay, touchX, touchY);
                        mGraphicOverlay.add(remoteUserProxy);
                        remoteUsersDisplayed = true;
                    }
                }
                break;
        }
    ...
    private void showPopupWindow(Graphic graphic){
        Context context = getApplicationContext();

        // Get the activity
        Activity mActivity = MultiTrackerActivity.this;
        ...
        View customView = inflater.inflate(R.layout.jira_detail_popup,null);
